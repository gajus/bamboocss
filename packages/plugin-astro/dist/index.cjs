...
*/
let convert;
const load = () => convert ??= (0, node_module.createRequire)(require("url").pathToFileURL(__filename).href)("@astrojs/compiler/sync").convertToTSX;
...
//#endregion
exports.astroToTsx = astroToTsx;
exports.pluginAstro = pluginAstro;
