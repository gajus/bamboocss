...
import { resolveTsPathPattern, resolveTsPathPattern as resolveTsPathPattern$1 } from "@bamboocss/config/ts-path";
...
const foldSource = (options) => {
	...
	*/
	...
	const matchesModule = (mod, entries) => {
		...
		if (pathMappings) {
			const resolved = resolveTsPathPattern$1(pathMappings, mod);
...
//#endregion
export { createRuntimeCss, createStaticStyleSetCompiler, foldSource, resolveTsPathPattern };
