...
`cssgen:done` runs just before the CSS is written to disk by the CLI or emitted by the Vite plugin. It receives the
artifact being written and the CSS as a string, and whatever you return replaces it — return nothing to leave it alone.
