...
The CLI uses the same [build platform requirements](/docs/installation/vite#build-platform-requirements) as the Vite
plugin. Supported published packages include the required native extractor; Rust is only needed to build Bamboo itself.
