...
`bamboo init --postcss` is refused: PostCSS is not a styling integration. Use
...
| `--postcss, -p`         | Refused — PostCSS is not a styling integration                                  | [Vite](/docs/installation/vite)                               |
